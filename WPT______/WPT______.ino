...
void loop() {
  ...
  if (aizu == 'a') {
    ...
    MsTimer2::stop();
    si5351.set_freq(0, SI5351_CLK0);    /*信号を止める*/            /*!!!!!set_freq(0)!!!これでは止まらない!!!!!*/
    k=5k;
    t=1;
  }
...
void receive_duty_data() {
  ...
  data0 = data.toInt();
  unsigned long long freq = data0 * 100;
  k=k+freq;/*1=0.01Hzなので末尾に00をつける.入力単位をキロにしたいので末尾に10^3をつける．*/
  si5351.set_freq(k, SI5351_CLK0);       /*周波数セット*/
